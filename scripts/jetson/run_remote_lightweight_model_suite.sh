...
candidate_variants_text="${JETSON_LIGHTWEIGHT_CANDIDATE_VARIANTS:-smolvlm2-256m-q8-smoke qwen3-vl-2b-thinking-q4-smoke hunyuanocr-q8-smoke youtu-vl-4b-q8-smoke youtu-vl-4b-q4-thirdparty-smoke}"
