"""Jetson memory diagnostics artifact contract tests."""
...
class JetsonMemoryDiagnosticsContractsTest(unittest.TestCase):
    def test_memory_diagnostics_launcher_runs_python_module_with_default_output(self):
        ...
        self.assertIn('output="${JETSON_MEMORY_DIAGNOSTICS_OUTPUT:-${repo_root}/outputs/jetson_inspect/memory-diagnostics-', script)
