...
3. Run the dedicated Tencent Hy-MT1.5/Hy-MT2 text/router suite separately if a
   ...
   evidence, use `tencent-hy-mt2-q8-smoke64-cached-20260531T132724Z` only as
   one-trial Q8 cached evidence, and treat low-bit failures as
