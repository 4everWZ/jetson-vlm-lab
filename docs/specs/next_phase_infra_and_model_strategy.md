...
3. Run the dedicated Tencent Hy-MT1.5/Hy-MT2 text/router suite separately if a
   ...
   evidence, rerun Q8 cached after the harness cleanup fix, and treat low-bit
   failures as runtime-compatibility evidence.
